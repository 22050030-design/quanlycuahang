      ...
      <div className="container">
        <div className="row g-4">
          <div className="col-md-4">
            ...
            <p className="mb-0 small">Website: www.dodunggia dung.vn</p>
          </div>
          <div className="col-md-4">
            ...
            <ul className="list-unstyled mb-0 small">
              ...
              <li className="mb-2"><a href="/gioi-thieu" className="text-white text-decoration-none">Giới thiệu</a></li>
              <li className="mb-2"><a href="/tuyen-dung" className="text-white text-decoration-none">Tuyển dụng</a></li>
              <li className="mb-2"><a href="/lien-he" className="text-white text-decoration-none">Liên hệ</a></li>
              <li className="mb-0"><a href="/so-do-website" className="text-white text-decoration-none">Sơ đồ website</a></li>
            </ul>
          </div>
          <div className="col-md-4">
